...
function actualizeazaDateFacturi(){
    ...
    .then(function(obFacturi) {
        ...
        for (let factura of obFacturi){
            for(let carte of factura.produse){
                dateGrafic[carte.nume]=dateGrafic[carte.nume]?dateGrafic[carte.nume]+1:1
                if(!culoriDate[carte.nume])culoriDate[carte.nume]=culoareRandom();
            }
        }
